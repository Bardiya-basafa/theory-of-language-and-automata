...
def main():
    ...
    # life.insertFromFile("pat-dragon spaceship.cells", (0,100))
    # life.insertFromFile("pat-ak94 gun.cells", (100,100))
    # life.insertFromFile("pat-vacuumgun gun.cells", (100,100))
    # life.insertFromFile("pat-stargate oscillator.cells", (100,100))
    # life.insertFromFile("pat-7enginecordership spaceship.cells", (100,100))
    # life.insertFromFile("pat-3enginecordership gun 279x258.cells", (100, 100))
